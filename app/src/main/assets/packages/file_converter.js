/* METADATA
{
    ...
    "display_name": {
        "ru": "File Converter", "en": "File Converter"
    },
    "description": {
        "ru": "Comprehensive file format conversion. Supports converting between common audio/video (MP4, MOV, MP3, WAV), images (JPG, PNG, WEBP), and documents (Markdown, HTML, DOCX, PDF).", "en": "Comprehensive file format conversion. Supports converting between common audio/video (MP4, MOV, MP3, WAV), images (JPG, PNG, WEBP), and documents (Markdown, HTML, DOCX, PDF)."
    },
    ...
    "tools": [
        {
            "name": "convert_file",
            "description": {
                "ru": "Convert files using external CLI tools such as FFmpeg, ImageMagick, and Pandoc. Supports audio/video, images, and documents. If a required tool is missing, it will attempt to install it automatically.", "en": "Convert files using external CLI tools such as FFmpeg, ImageMagick, and Pandoc. Supports audio/video, images, and documents. If a required tool is missing, it will attempt to install it automatically."
            },
            "parameters": [
                { "name": "input_path", "description": { "ru": "Input file path.", "en": "Input file path." }, "type": "string", "required": true },
                { "name": "output_path", "description": { "ru": "Output file path. The file extension determines the target format.", "en": "Output file path. The file extension determines the target format." }, "type": "string", "required": true },
                { "name": "options", "description": { "ru": "Optional CLI options for the conversion tool (e.g. set '-quality 80' for ImageMagick).", "en": "Optional CLI options for the conversion tool (e.g. set '-quality 80' for ImageMagick)." }, "type": "string", "required": false }
            ]
        }
    ]
}*/
